...
echo "CONTROL: starting local testing runs on datasets for figure 3"
...
# testing parameters
declare -r training_opt="0"
declare -r nb_trials="3"
        ...
        do
            ...
            do
                ...
                do
                    ...
                    for i in {0..0..1}
                    do
                        echo "CONTROL: running testing trials of ${train_pts[$i]} point trials"
